  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <button className="nav-btn" title="Trip">
        ...
        <button className="nav-btn" title="Music">
